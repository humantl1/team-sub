/**
 * Home route shows the Tailwind-driven showcase we bootstrapped earlier.
 * Keeping it as the index route lets us reuse the polished demo while we wire real data later.
 */
...
export function HomeRoute() {
  ...
  /**
   * Cycling the gradient class lets QA confirm interactive styling survives the router/provider refactor.
   */
  ...
  return (
    <div
      className={`flex min-h-full w-full flex-1 flex-col items-center justify-center bg-gradient-to-br ${gradientClass} px-4 py-12 text-slate-100 transition-colors duration-500`}
    >
